...
str :: String
str = "a\x62\x63\x63\x16805\x16A06z"
...
testStringCodePoints = do
  ...
  assertEqual
    ...
    , expected: Just "(CodePoint 0x62)"
    }
  assertEqual
    { actual: map show (SCP.codePointAt 2 str)
    , expected: Just "(CodePoint 0x63)"
    }
  assertEqual
  ...
  assertEqual
    { actual: SCP.codePointAt 1 str
    , expected: (toEnum 0x62)
    }
  assertEqual
    { actual: SCP.codePointAt 2 str
    , expected: (toEnum 0x63)
    }
  assertEqual
  ...
  assertEqual
    ...
    , expected: Just {head: cp 0x61, tail:  "\x62\x63\x63\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.uncons (SCP.drop 1 str)
    , expected: Just {head: cp 0x62, tail: "\x63\x63\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.uncons (SCP.drop 2 str)
    , expected: Just {head: cp 0x63, tail: "\x63\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.uncons (SCP.drop 3 str)
    , expected: Just {head: cp 0x63, tail: "\x16805\x16A06z"}
    }
  assertEqual
  ...
  assertEqual
    { actual: SCP.countPrefix (\x -> fromEnum x < 0x62) str
    , expected: 1
    }
  ...
  assertEqual
    { actual: SCP.indexOf (Pattern "\x62\x63\x63") str
    , expected: Just 1
    }
  assertEqual
    { actual: SCP.indexOf (Pattern "\x63") str
    , expected: Just 2
    }
  assertEqual
    { actual: SCP.indexOf (Pattern "\x63\x63") str
    , expected: Just 2
    }
  assertEqual
  ...
  assertEqual
    { actual: SCP.lastIndexOf (Pattern "\x62\x63\x63") str
    , expected: Just 1
    }
  assertEqual
    { actual: SCP.lastIndexOf (Pattern "\x63") str
    , expected: Just 3
    }
  assertEqual
    { actual: SCP.lastIndexOf (Pattern "\x63\x63") str
    , expected: Just 2
    }
  assertEqual
  ...
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 7 str
    , expected: Just 3
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 6 str
    , expected: Just 3
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 5 str
    , expected: Just 3
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 4 str
    , expected: Just 3
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 3 str
    , expected: Just 3
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 2 str
    , expected: Just 2
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 1 str
    , expected: Nothing
    }
  assertEqual
    { actual: SCP.lastIndexOf' (Pattern "\x63") 0 str
    , expected: Nothing
    }
  assertEqual
  ...
  assertEqual
    ...
    , expected: "a\x62\x63\x63"
    }
  assertEqual
    { actual: SCP.take 5 str
    , expected: "a\x62\x63\x63\x16805"
    }
  assertEqual
    { actual: SCP.take 6 str
    , expected: "a\x62\x63\x63\x16805\x16A06"
    }
  assertEqual
  ...
  assertEqual
    { actual: SCP.takeWhile (\c -> fromEnum c < 0x62) str
    , expected: "a"
    }
  ...
  assertEqual
    { actual: SCP.drop 1 str
    , expected: "\x62\x63\x63\x16805\x16A06z"
    }
  assertEqual
    { actual: SCP.drop 2 str
    , expected: "\x63\x63\x16805\x16A06z"
    }
  assertEqual
    { actual: SCP.drop 3 str
    , expected: "\x63\x16805\x16A06z"
    }
  assertEqual
  ...
  assertEqual
    { actual: SCP.dropWhile (\c -> fromEnum c < 0x62) str
    , expected: "\x62\x63\x63\x16805\x16A06z"
    }
  ...
  assertEqual
    ...
    , expected: {before: "a", after: "\x62\x63\x63\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.splitAt 2 str
    , expected: {before: "a\x62", after: "\x63\x63\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.splitAt 3 str
    , expected: {before: "a\x62\x63", after: "\x63\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.splitAt 4 str
    , expected: {before: "a\x62\x63\x63", after: "\x16805\x16A06z"}
    }
  assertEqual
    { actual: SCP.splitAt 5 str
    , expected: {before: "a\x62\x63\x63\x16805", after: "\x16A06z"}
    }
  assertEqual
    { actual: SCP.splitAt 6 str
    , expected: {before: "a\x62\x63\x63\x16805\x16A06", after: "z"}
    }
  assertEqual
